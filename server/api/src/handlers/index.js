...
const H = {};
Object.assign(H, require('./stubs'), require('./bootstrap'), require('./messages'), require('./account'), require('./plan'), require('./record'), require('./meds'), require('./money'), require('./coordinator'), require('./docs'), require('./archive'));   // real handlers win over stubs
